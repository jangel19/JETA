      ...
      <div className="relative z-10">
        ...
        <div className="h-screen flex items-center justify-center px-4">
          <div className="text-center max-w-4xl px-6 space-y-6">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl leading-relaxed text-white/90 font-light max-w-3xl mx-auto">
              We help small developers and investors <span className="font-semibold text-blue-300">underwrite deals in seconds</span> with crystal-clear math and AI-powered insights.
            </p>
            <div className="inline-block px-6 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white/80 text-sm">
        ...
        <div className="h-screen flex items-center justify-center px-4">
          <div className="max-w-4xl px-6 space-y-8">
            ...
            <div className="text-center space-y-4">
              <div className="inline-block px-4 py-1.5 rounded-full bg-purple-500/20 border border-purple-400/30 text-purple-300 text-sm font-medium mb-4">
              ...
              <p className="text-xl md:text-2xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
                Our engine analyzes <span className="text-blue-300 font-semibold">zoning laws</span>, <span className="text-purple-300 font-semibold">comparable sales</span>, and <span className="text-green-300 font-semibold">market risk</span> in real time.
              </p>
            </div>
            {/* ...decision cards... */}
            <div className="grid md:grid-cols-3 gap-4 mt-8">
              <div className="p-6 rounded-2xl bg-emerald-500/10 border border-emerald-400/30 backdrop-blur-sm text-center hover:scale-105 transition-transform duration-300">
                <div className="text-4xl font-bold text-emerald-300 mb-2">BUY</div>
                <div className="text-sm text-slate-300">Strong ROI potential</div>
              </div>
              <div className="p-6 rounded-2xl bg-yellow-500/10 border border-yellow-400/30 backdrop-blur-sm text-center hover:scale-105 transition-transform duration-300">
                <div className="text-4xl font-bold text-yellow-300 mb-2">MAYBE</div>
                <div className="text-sm text-slate-300">Needs deeper analysis</div>
              </div>
              <div className="p-6 rounded-2xl bg-red-500/10 border border-red-400/30 backdrop-blur-sm text-center hover:scale-105 transition-transform duration-300">
                <div className="text-4xl font-bold text-red-300 mb-2">PASS</div>
                <div className="text-sm text-slate-300">Risk outweighs reward</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="h-screen flex items-center justify-center px-4">
          <div className="max-w-4xl px-6 space-y-8">
            {/* ...section content... */}
            <div className="text-center space-y-4">
              <div className="inline-block px-4 py-1.5 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-300 text-sm font-medium mb-4">
                ⚡ Lightning Fast
              </div>
              <h3 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-5xl font-extrabold text-white mb-2">15-30s</div>
                <div className="text-sm text-slate-400">Per deal analysis</div>
              </div>
              <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-5xl font-extrabold text-white mb-2">10×</div>
                <div className="text-sm text-slate-400">More deals screened</div>
              </div>
              <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm text-center hover:bg-white/10 transition-all duration-300">
                <div className="text-5xl font-extrabold text-white mb-2">3</div>
                <div className="text-sm text-slate-400">Free reports/month</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="h-screen flex items-center justify-center px-4">
          <div className="text-center max-w-4xl px-6 space-y-8">
            <div className="space-y-4">
              <h3 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight">
